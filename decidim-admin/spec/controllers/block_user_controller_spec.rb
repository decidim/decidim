    ...
    describe BlockUserController, type: :controller do
      ...
      describe "unblock" do
        ...
        context "when its a user group" do
          let!(:user) { create(:user_group, :blocked, :confirmed, organization: organization, nickname: "another_nickname") }
      ...
      describe "block" do
        ...
        context "when its a user group" do
          let!(:user) { create(:user_group, :confirmed, organization: organization, nickname: "another_nickname") }
