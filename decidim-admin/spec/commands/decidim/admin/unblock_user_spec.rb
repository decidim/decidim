...
module Decidim::Admin
  describe UnblockUser do
    ...
    let(:extended_data) { { user_name: user_name } }
    ...
    context "with a user" do
      let(:user_to_unblock) { create :user, :blocked, extended_data: extended_data }
    ...
    context "with a user group" do
      let(:user_to_unblock) { create :user_group, :blocked, extended_data: extended_data }
