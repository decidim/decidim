  ...
  module Admin
    ...
    class Engine < ::Rails::Engine
      ...
      initializer "decidim_admin.register_icons" do |_app|
        ...
        Decidim.icons.register(name: "lock-line", icon: "lock-line", resource: "admin", category: "system", description: "", engine: :admin)
        Decidim.icons.register(name: "download-line", icon: "download-line", resource: "admin", category: "system", description: "", engine: :admin)
        Decidim.icons.register(name: "mail-open-line", icon: "mail-open-line", resource: "admin", category: "system", description: "", engine: :admin)
        Decidim.icons.register(name: "forbid-2-line", icon: "forbid-2-line", resource: "admin", category: "system", description: "", engine: :admin)
        ...
        Decidim.icons.register(name: "attachment-2", icon: "attachment-2", resource: "admin", category: "system", description: "", engine: :admin)
        Decidim.icons.register(name: "spy-line", icon: "spy-line", resource: "admin", category: "system", description: "", engine: :admin)
        Decidim.icons.register(name: "refresh-line", icon: "refresh-line", resource: "admin", category: "system", description: "", engine: :admin)
        Decidim.icons.register(name: "zoom-in-line", icon: "zoom-in-line", resource: "admin", category: "system", description: "", engine: :admin)
        Decidim.icons.register(name: "add-line", icon: "add-line", resource: "admin", category: "system", description: "", engine: :admin)
        Decidim.icons.register(name: "upload-line", icon: "upload-line", resource: "admin", category: "system", description: "", engine: :admin)
        Decidim.icons.register(name: "settings-4-line", icon: "settings-4-line", resource: "admin", category: "system", description: "", engine: :admin)

        Decidim.icons.register(name: "folder-line", icon: "folder-line", resource: "core", category: "system", description: "", engine: :admin)
        Decidim.icons.register(name: "attachment-line", icon: "attachment-line", resource: "core", category: "system", description: "", engine: :admin)
      end
