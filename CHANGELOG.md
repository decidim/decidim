...
- **decidim-meetings**: Fix meeting update and creation when its participatory space has a scope without subscopes. [\#2731](https://github.com/decidim/decidim/pull/2731)
