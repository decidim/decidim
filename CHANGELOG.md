...
- **decidim-consultations**: Backport fix permissions in order to make components inside of questions accessible. [\#6114](https://github.com/decidim/decidim/pull/6114)
