...
| ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| New user-accessible endpoint / mutation / resolver               | Permission spec testing the intended access policy: denial attempts the policy refuses (unauthenticated, wrong-role, cross-org, as applicable) are rejected, and allowed access succeeds (not required for internal commands with no user boundary; resource-level authorization inherited from the enclosing type still needs denial coverage) |
