...
describe Decidim::Forms::QuestionnaireUserAnswers do
  ...
  let!(:answers_user_1) { questions.map { |question| create :question_answer, user: user_1, questionnaire: questionnaire, question: question } }
  let!(:answers_user_2) { questions.map { |question| create :question_answer, user: user_2, questionnaire: questionnaire, question: question } }
