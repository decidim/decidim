...
describe Decidim::Forms::QuestionnaireUserAnswers do
  ...
  let!(:questions) do
    [
      ...
      create(:questionnaire_question, :text_separator, questionnaire: questionnaire, position: 4),
  ...
  it "returns the user answers for each user without the separators and text-separators" do
