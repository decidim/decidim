...
module Decidim
  module Forms
    # This class holds a Form to answer a questionnaire questions from Decidim's public page.
    class QuestionsForm < Decidim::Form
      include ActiveModel::Validations::Callbacks

      # as questionnaire questions uses "answers" for the database relationships is
