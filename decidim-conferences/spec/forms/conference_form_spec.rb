  ...
  module Conferences
    module Admin
      describe ConferenceForm do
        ...
        let!(:taxonomy_filter1) { create(:taxonomy_filter, space_manifest: "conferences", root_taxonomy:) }
        let!(:taxonomy_filter2) { create(:taxonomy_filter, space_manifest: "conferences", root_taxonomy:) }
