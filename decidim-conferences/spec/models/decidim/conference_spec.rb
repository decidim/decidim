...
module Decidim
  describe Conference do
    ...
    context "when there is an conference with the same slug in the same organization" do
    ...
    context "when there is an conference with the same slug in another organization" do
