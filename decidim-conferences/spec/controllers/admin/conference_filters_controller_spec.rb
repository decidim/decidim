...
module Decidim
  module Conferences
    module Admin
      describe ConferenceFiltersController do
        ...
        let!(:taxonomy_filter1) { create(:taxonomy_filter, root_taxonomy: taxonomy1.parent, space_manifest: "conferences") }
        let!(:taxonomy_filter2) { create(:taxonomy_filter, root_taxonomy: taxonomy2.parent, space_manifest: "conferences") }
        ...
        it "helper breadcrumb_manage_partial returns the correct partial" do
          expect(controller.helpers.breadcrumb_manage_partial).to eq("layouts/decidim/admin/manage_conferences")
        end
      end
    end
  end
