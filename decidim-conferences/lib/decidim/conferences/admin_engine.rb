    ...
    class AdminEngine < ::Rails::Engine
      ...
      initializer "decidim_conferences.conferences_admin_registrations_menu" do
        Decidim.menu :conferences_admin_registrations_menu do |menu|
          menu.item I18n.t("registration_types", scope: "decidim.admin.menu.conferences_submenu"),
          ...
          menu.item I18n.t("user_registrations", scope: "decidim.admin.menu.conferences_submenu"),
          ...
          menu.item I18n.t("conference_invites", scope: "decidim.admin.menu.conferences_submenu"),
          ...
          menu.item I18n.t("diploma", scope: "decidim.admin.menu.conferences_submenu"),
      ...
      initializer "decidim_conferences.conferences_admin_attachments_menu" do
        Decidim.menu :conferences_admin_attachments_menu do |menu|
          menu.item I18n.t("attachment_collections", scope: "decidim.admin.menu.conferences_submenu"),
          ...
          menu.item I18n.t("attachment_files", scope: "decidim.admin.menu.conferences_submenu"),
      ...
      initializer "decidim_conferences.conferences_admin_menu" do
        Decidim.menu :conferences_admin_menu do |menu|
          menu.item I18n.t("info", scope: "decidim.admin.menu.conferences_submenu"),
          ...
          menu.item I18n.t("components", scope: "decidim.admin.menu.conferences_submenu"),
          ...
          menu.item I18n.t("attachments", scope: "decidim.admin.menu.conferences_submenu"),
                    "#",
                    active: is_active_link?(decidim_admin_conferences.conference_attachment_collections_path(current_participatory_space)) ||
          ...
          menu.item I18n.t("partners", scope: "decidim.admin.menu.conferences_submenu"),
          ...
          menu.item I18n.t("conference_speakers", scope: "decidim.admin.menu.conferences_submenu"),
          ...
          menu.item I18n.t("registrations", scope: "decidim.admin.menu.conferences_submenu"),
                    "#",
          ...
          menu.item I18n.t("moderations", scope: "decidim.admin.menu.conferences_submenu"),
