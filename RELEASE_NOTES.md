...
NOTE: Please note this release is updating Rails version from 7.2.2 to 7.2.3. Please make sure you backup your `SECRET_KEY_BASE` env variable and also `tmp/local_secret.txt` if you have it.
