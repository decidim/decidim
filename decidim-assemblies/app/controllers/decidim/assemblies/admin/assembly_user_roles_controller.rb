  ...
  module Assemblies
    module Admin
      ...
      class AssemblyUserRolesController < Decidim::Assemblies::Admin::ApplicationController
        ...
        def index
          enforce_permission_to :index, :assembly_role
          @assembly_user_roles = collection
        end

        def new
          enforce_permission_to :create, :assembly_role
        ...
        def edit
          ...
          enforce_permission_to :update, :assembly_role, assembly_role: @user_role
        ...
        def destroy
          ...
          enforce_permission_to :destroy, :assembly_role, assembly_role: @assembly_user_role
        ...
        def resend_invitation
          @user_role = collection.find(params[:id])
          enforce_permission_to :invite, :assembly_role, assembly_role: @user_role
