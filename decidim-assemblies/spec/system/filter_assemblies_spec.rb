...
describe "Assemblies", type: :system do
  ...
  context "when there are published assemblies" do
    ...
    context "and filtering parent assemblies by assembly_type" do
      before do
    ...
    context "and filtering parent assemblies by scope" do
    ...
    context "and filtering parent assemblies by area" do
