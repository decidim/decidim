...
describe "Assembly members" do
  ...
  context "when there are no assembly members and directly accessing from URL" do
    it_behaves_like "a 404 page" do
      let(:target_path) { decidim_assemblies.assembly_members_path(assembly, locale: I18n.locale) }
    end
  end
  ...
  context "when the assembly does not exist" do
    it_behaves_like "a 404 page" do
      let(:target_path) { decidim_assemblies.assembly_members_path(assembly_slug: 999_999_999, locale: I18n.locale) }
    end
  end
    ...
    context "and accessing from the assembly homepage" do
      ...
      context "and the main data content block is enabled" do
        ...
        it "the menu link is shown" do
          ...
          expect(page).to have_current_path decidim_assemblies.assembly_members_path(assembly, locale: I18n.locale)
        end
      end
