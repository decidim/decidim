...
require "./db/data/20260104094930_remove_assemblies_types_references"

describe RemoveAssembliesTypesReferences do
  let(:migrator) do
  ...
  let(:process_type) { "Decidim::AssembliesType" }
  ...
  describe "#up" do
    context "with notifications" do
      ...
      it "deletes notifications referencing assembly types" do
    ...
    context "with action logs" do
      ...
      it "deletes action logs referencing assembly types" do
    ...
    context "with paper trail versions" do
      ...
      it "deletes paper trail versions for assembly types" do
