...
module Decidim
  module Assemblies
    describe AssembliesMetricType, type: :graphql do
      ...
      let!(:models) do
        (0..4).each do |count|
          create(:metric, day: (today - count.days), cumulative: (4 - count), quantity: 1, metric_type: "assemblies", organization: current_organization)
        end
      end
      ...
      describe "count" do
        ...
        it "returns the Assembly's last day cumulative count count" do
