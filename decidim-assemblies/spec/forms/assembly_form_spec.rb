  ...
  module Assemblies
    module Admin
      describe AssemblyForm do
        ...
        let!(:taxonomy_filter1) { create(:taxonomy_filter, partcipatory_space_manifests: ["assemblies"], root_taxonomy:) }
        let!(:taxonomy_filter2) { create(:taxonomy_filter, partcipatory_space_manifests: ["assemblies"], root_taxonomy:) }
        let!(:taxonomy_filter3) { create(:taxonomy_filter, partcipatory_space_manifests: ["participatory_processes"], root_taxonomy:) }
        let!(:taxonomy_filter4) { create(:taxonomy_filter, partcipatory_space_manifests: ["assemblies"], root_taxonomy:) }
        let(:attributes) do
          {
            "assembly" => {
              "title_en" => title[:en],
