    ...
    class AdminEngine < ::Rails::Engine
      ...
      initializer "decidim_assemblies.assemblies_admin_attachments_menu" do
        Decidim.menu :assemblies_admin_attachments_menu do |menu|
          menu.item I18n.t("attachment_collections", scope: "decidim.admin.menu.assemblies_submenu"),
          ...
          menu.item I18n.t("attachment_files", scope: "decidim.admin.menu.assemblies_submenu"),
      ...
      initializer "decidim_assemblies.assemblies_admin_menu" do
        Decidim.menu :assemblies_admin_menu do |menu|
          menu.item I18n.t("info", scope: "decidim.admin.menu.assemblies_submenu"),
          ...
          menu.item I18n.t("components", scope: "decidim.admin.menu.assemblies_submenu"),
          ...
          menu.item I18n.t("assembly_admins", scope: "decidim.admin.menu.assemblies_submenu"),
          ...
          menu.item I18n.t("private_users", scope: "decidim.admin.menu.assemblies_submenu"),
          ...
          menu.item I18n.t("moderations", scope: "decidim.admin.menu.assemblies_submenu"),
