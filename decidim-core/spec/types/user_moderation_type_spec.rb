  ...
  module Core
    describe UserModerationType do
      ...
      describe "about" do
        ...
        it "returns the moderated user's about" do
      ...
      describe "block_reasons" do
        ...
        it "returns the moderated user's block_reasons" do
      ...
      describe "blocked_at" do
        ...
        it "returns the moderated user's blockedAt" do
      ...
      describe "blocking_user" do
        ...
        it "returns the moderated user's blockingUser" do
      ...
      describe "reports" do
        ...
        it "returns the moderated user's reports" do
      ...
      describe "id" do
        ...
        it "returns the moderated user's id" do
      ...
      describe "user_id" do
        ...
        it "returns the moderated user's userId" do
