...
describe "Invitation password field" do
  ...
  context "when inviting an admin" do
    ...
    it "displays admin password requirements in help text" do
    ...
    it "allows accepting invitation with valid admin password" do
      visit last_email_link

      fill_in :invitation_user_nickname, with: "invited_admin"
      fill_in :invitation_user_password, with: "decidim123456789XYZ#"
