...
describe Decidim::PublicComponents do
  ...
  let!(:published_component2) { create(:component, :published, participatory_space: process, manifest_name: "proposals") }
  ...
  context "when filtering by manifest_name" do
    subject { described_class.new(organization, manifest_name: "proposals") }
