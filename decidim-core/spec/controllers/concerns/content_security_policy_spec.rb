  ...
  module Headers
    describe "ContentSecurityPolicy", type: :controller do
      ...
      it "sets the appropiate headers" do
        ...
        expect(response.headers["Content-Security-Policy"]).to include("connect-src 'self' *.hereapi.com;")
      ...
      context "when content policy is added by organization" do
        ...
        it "sets the appropiate headers" do
          ...
          expect(response.headers["Content-Security-Policy"]).to include("connect-src 'self' *.hereapi.com https://connect.example.org;")
