FactoryGirl.define do
  ...
  factory :process, class: Decidim::ParticipatoryProcess do
    ...
    hero_image { Rack::Test::UploadedFile.new(File.join(File.dirname(__FILE__), 'support', 'city.jpeg')) }
    banner_image { Rack::Test::UploadedFile.new(File.join(File.dirname(__FILE__), 'support', 'city2.jpeg')) }
    organization
  end
