...
module Decidim
  describe Resourceable do
    ...
    describe "linked_resources" do
      ...
      let!(:target_feature) { create(:feature, manifest_name: :dummy, featurable: participatory_process) }
      let!(:current_feature) { create(:feature, manifest_name: :dummy, featurable: participatory_process) }
    ...
    describe "#linked_classes_for" do
      ...
      let(:meetings_feature) { create :feature, manifest_name: "meetings", featurable: proposals_feature_1.featurable }
      let(:results_feature) { create :feature, manifest_name: "results", featurable: proposals_feature_2.featurable }
