...
module Decidim
  describe DemotedMembershipEvent do
    ...
    let(:event_name) { "decidim.events.groups.demoted_membership" }
    ...
    describe "email_subject" do
      it "is generated correctly" do
        expect(subject.email_subject).to include("You are no longer an admin")
      end
    end
