...
module Decidim
  describe JoinRequestAcceptedEvent do
    ...
    let(:event_name) { "decidim.events.groups.join_request_accepted" }
    ...
    describe "email_subject" do
      it "is generated correctly" do
        expect(subject.email_subject).to include("You have been accepted")
      end
    end
