...
describe "Participatory Processes", type: :feature do
  ...
  describe "when going to the participatory process page" do
    let!(:participatory_process) { base_process }
    let!(:proposals_feature) { create(:feature, :published, featurable: participatory_process, manifest_name: :proposals) }
    let!(:meetings_feature) { create(:feature, :unpublished, featurable: participatory_process, manifest_name: :meetings) }
