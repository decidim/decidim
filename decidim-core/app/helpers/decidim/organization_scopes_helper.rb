...
module Decidim
  ...
  module OrganizationScopesHelper
    ...
    def organization_scopes(organization = current_organization)
      [Struct.new(:id, :name).new(0, I18n.t("decidim.participatory_processes.scopes.global"))] + organization.scopes
    end
    ...
    # to use a specific Numbre as ID (`0`, in our case), and then treat this
