...
describe("Image", () => {
  ...
  let editorInnerHTML = (dim, src, alt) => {
    return `<div data-image-resizer="" class="ProseMirror-selectednode" draggable="true"><div data-image-resizer-wrapper=""><button type="button" aria-label="Resize image (top left corner)" data-image-resizer-control="top-left"></button><button type="button" aria-label="Resize image (top right corner)" data-image-resizer-control="top-right"></button><button type="button" aria-label="Resize image (bottom left corner)" data-image-resizer-control="bottom-left"></button><button type="button" aria-label="Resize image (bottom right corner)" data-image-resizer-control="bottom-right"></button><div data-image-resizer-dimensions=""><span data-image-resizer-dimension="width" data-image-resizer-dimension-value="${dim}"></span>×<span data-image-resizer-dimension="height" data-image-resizer-dimension-value="${dim}"></span></div><div class="editor-content-image" data-image=""><img src="${src}" alt="${alt}"></div></div></div>`;
  }
