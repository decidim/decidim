...
module Decidim
  # This class handles all the logic associated to configuring a featurable, the
  # highest level object of Decidim.
  #
  # It's normally not used directly but through the API exposed through
  # `Decidim.register_featurable`.
  class FeaturableManifest
