...
module Decidim
  ...
  module Searchable
    ...
    included do
      ...
      #
      def try_update_index_for_search_resource(visited = [])
        ...
        find_and_update_descendants(visited)
      end

      private

      def find_and_update_descendants(visited = [])
        Decidim::FindAndUpdateDescendantsJob.perform_later(self, visited)
      end
