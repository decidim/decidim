  ...
  module Core
    ...
    class Engine < ::Rails::Engine
      ...
      initializer "decidim_core.register_icons" do
        ...
        Decidim.icons.register(name: "close-line", icon: "close-line", resource: "core", category: "system", description: "Close icon", engine: :core)
        Decidim.icons.register(name: "save-line", icon: "save-line", resource: "core", category: "system", description: "Save icon", engine: :core)
        Decidim.icons.register(name: "search-line", icon: "search-line", resource: "core", category: "system", description: "Search icon", engine: :core)
        Decidim.icons.register(name: "timer-line", icon: "timer-line", resource: "core", category: "system", description: "Timer icon", engine: :core)
        Decidim.icons.register(name: "arrow-down-s-line", icon: "arrow-down-s-line", resource: "core", category: "system", description: "Arrow down icon", engine: :core)
        Decidim.icons.register(name: "arrow-up-s-line", icon: "arrow-up-s-line", resource: "core", category: "system", description: "Arrow up icon", engine: :core)
        Decidim.icons.register(name: "road-map-line", icon: "road-map-line", resource: "core", category: "system", description: "Road map icon", engine: :core)
        Decidim.icons.register(name: "bubble-chart-line", icon: "bubble-chart-line", resource: "core", category: "system", description: "Road map icon", engine: :core)
        Decidim.icons.register(name: "user-smile-line", icon: "user-smile-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "account-circle-line", icon: "account-circle-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "notification-3-line", icon: "notification-3-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "mail-send-line", icon: "mail-send-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "logout-box-r-line", icon: "logout-box-r-line", resource: "core", category: "system", description: "", engine: :core)
        ...
        Decidim.icons.register(name: "github-fill", icon: "github-fill", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "global-line", icon: "global-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "creative-commons-line", icon: "creative-commons-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "creative-commons-by-line", icon: "creative-commons-by-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "creative-commons-sa-line", icon: "creative-commons-sa-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "delete-bin-line", icon: "delete-bin-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "loader-3-line", icon: "loader-3-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "share-line", icon: "share-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "facebook-circle-line", icon: "facebook-circle-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "whatsapp-line", icon: "whatsapp-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "telegram-line", icon: "telegram-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "file-copy-line", icon: "file-copy-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "check-double-line", icon: "check-double-line", resource: "core", category: "system", description: "", engine: :core)
        ...
        Decidim.icons.register(name: "checkbox-circle-line", icon: "checkbox-circle-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "equalizer-line", icon: "equalizer-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "dashboard-line", icon: "dashboard-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "information-line", icon: "information-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "question-answer-line", icon: "question-answer-line", resource: "core", category: "system", description: "", engine: :core)

        Decidim.icons.register(name: "account-pin-circle-line", icon: "account-pin-circle-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "link", icon: "link", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "award-line", icon: "award-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "eye-2-line", icon: "eye-2-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "group-line", icon: "group-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "team-line", icon: "team-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "apps-2-line", icon: "apps-2-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "chat-1-line", icon: "chat-1-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "discuss-line", icon: "discuss-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "lightbulb-flash-line", icon: "lightbulb-flash-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "map-pin-line", icon: "map-pin-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "pen-nib-line", icon: "pen-nib-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "pencil-line", icon: "pencil-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "close-circle-line", icon: "close-circle-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "contacts-line", icon: "contacts-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "user-settings-line", icon: "user-settings-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "user-star-line", icon: "user-star-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "user-add-line", icon: "user-add-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "share-forward-line", icon: "share-forward-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "star-s-fill", icon: "star-s-fill", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "arrow-left-line", icon: "arrow-left-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "file-3-line", icon: "file-3-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "play-fill", icon: "play-fill", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "fingerprint-line", icon: "fingerprint-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "list-check-2", icon: "list-check-2", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "notification-3-fill", icon: "notification-3-fill", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "pages-line", icon: "pages-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "mail-add-line", icon: "mail-add-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "tools-line", icon: "tools-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "eye-line", icon: "eye-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "government-line", icon: "government-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "mail-line", icon: "mail-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "live-line", icon: "live-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "home-gear-line", icon: "home-gear-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "check-double-fill", icon: "check-double-fill", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "file-list-3-line", icon: "file-list-3-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "price-tag-3-line", icon: "price-tag-3-line", resource: "core", category: "system", description: "", engine: :core)
        ...
        # Attachments
        Decidim.icons.register(name: "file-text-line", icon: "file-text-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "scales-2-line", icon: "scales-2-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "image-line", icon: "image-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "error-warning-line", icon: "error-warning-line", resource: "core", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "folder-open-line", icon: "folder-open-line", resource: "core", category: "system", description: "", engine: :core)

        Decidim.icons.register(name: "calendar-todo-line", icon: "calendar-todo-line", resource: "participatory_space", category: "system", description: "", engine: :core)
        Decidim.icons.register(name: "home-8-line", icon: "home-8-line", resource: "core", category: "system", description: "", engine: :core)

        Decidim.icons.register(name: "like", icon: "heart-add-line", description: "Like", category: "action", resource: "core", engine: :core)
        Decidim.icons.register(name: "dislike", icon: "dislike-line", description: "Dislike", category: "action", resource: "core", engine: :core)

        # Refactor
        Decidim.icons.register(name: "Decidim::Amendment", icon: "git-branch-line", resource: "Decidim::Amendment", category: "activity", description: "Amendment", engine: :core)
        Decidim.icons.register(name: "Decidim::Category", icon: "price-tag-3-line", description: "Category", category: "activity", resource: "core", engine: :core)
        Decidim.icons.register(name: "Decidim::Scope", icon: "scan-line", description: "Scope", category: "activity", resource: "core", engine: :core)
        Decidim.icons.register(name: "Decidim::User", icon: "user-line", description: "User", category: "activity", resource: "core", engine: :core)
        Decidim.icons.register(name: "Decidim::UserGroup", icon: "group-line", description: "User Group", category: "activity", resource: "core", engine: :core)
        Decidim.icons.register(name: "follow", icon: "notification-3-line", description: "Follow", category: "action", resource: "core", engine: :core)
        Decidim.icons.register(name: "unfollow", icon: "notification-3-fill", description: "Unfollow", category: "action", resource: "core", engine: :core)
        Decidim.icons.register(name: "share", icon: "share-line", description: "Share", category: "action", resource: "core", engine: :core)
        Decidim.icons.register(name: "nickname", icon: "account-pin-circle-line", description: "Nickname", category: "profile", resource: "core", engine: :core)
        Decidim.icons.register(name: "badges", icon: "award-line", description: "Badges", category: "profile", resource: "core", engine: :core)
        Decidim.icons.register(name: "profile", icon: "team-line", description: "Groups", category: "profile", resource: "core", engine: :core)
        Decidim.icons.register(name: "user_group", icon: "team-line", description: "Groups", category: "profile", resource: "core", engine: :core)
        Decidim.icons.register(name: "link", icon: "link", description: "web / URL", category: "profile", resource: "core", engine: :core)
        Decidim.icons.register(name: "following", icon: "eye-2-line", description: "Following", category: "profile", resource: "core", engine: :core)
        Decidim.icons.register(name: "activity", icon: "bubble-chart-line", description: "Activity", category: "profile", resource: "core", engine: :core)
        Decidim.icons.register(name: "followers", icon: "group-line", description: "Followers", category: "profile", resource: "core", engine: :core)
        Decidim.icons.register(name: "documents", icon: "file-text-line", description: "Document", category: "documents", resource: "core", engine: :core)
        Decidim.icons.register(name: "folder_open", icon: "folder-open-line", description: "Folder open", category: "documents", resource: "core", engine: :core)
        Decidim.icons.register(name: "folder_close", icon: "folder-line", description: "Folder close", category: "documents", resource: "core", engine: :core)
        Decidim.icons.register(name: "document_weight", icon: "scales-2-line", description: "Doc. weight (kb/mb)", category: "documents", resource: "core", engine: :core)
        Decidim.icons.register(name: "document_download", icon: "download-line", description: "Download", category: "documents", resource: "core", engine: :core)
        Decidim.icons.register(name: "images", icon: "image-line", description: "Images", category: "documents", resource: "core", engine: :core)
        Decidim.icons.register(name: "all", icon: "apps-2-line", description: "All", category: "other", resource: "core", engine: :core)
        Decidim.icons.register(name: "other", icon: "question-line", description: "Other", category: "other", resource: "core", engine: :core)
      end
