...
module Decidim
  module Core
    ...
    autoload :UploadFileType, "decidim/api/mutations/upload_file_type"
    ...
    autoload :AttachableCollectionMutations, "decidim/api/mutations/shared/attachable_collection_mutations"
