...
module Decidim
  module Core
    class TaxonomyType < Decidim::Api::Types::BaseObject
      ...
      field :children_count, GraphQL::Types::Int, "The number of children for this taxonomy."
      ...
      field :taxonomizations_count, GraphQL::Types::Int, "The number of taxonomizations for this taxonomy."
    end
  end
end
