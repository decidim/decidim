...
module Decidim
  module Core
    class ModerationType < Decidim::Api::Types::BaseObject
      ...
      field :report_count, GraphQL::Types::Int, "The number of reports for this resource", null: true
      field :reported_content, Decidim::Core::TranslatedFieldType, "The content that has been reported", null: true
      field :reported_url, GraphQL::Types::String, "The url of the resource that was reported", null: true
      field :reports, [Decidim::Core::ReportableType, { null: true }], "The reports for this resource", null: true
