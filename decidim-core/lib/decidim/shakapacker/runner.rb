  ...
  module Shakapacker
    module Runner
      def self.included(base)
        ...
        base.define_method :initialize do |argv, build_config = nil, bundler_override = nil, passthrough_argv = nil|
          decidim_initialize(argv, build_config, bundler_override)
          original_initialize(argv, build_config, bundler_override, passthrough_argv)
        end
      end

      private

      def decidim_initialize(_argv, _build_config = nil, _bundler_override = nil, _passthrough_argv = nil)
