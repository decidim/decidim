class Suggestion {
    ...
    _createMenuWrapper() {
      ...
      this.menuWrapper.style.top = `${this.firstNode.getBoundingClientRect().top - this.firstNode.offsetHeight - this.doc.getBoundingClientRect().top}px`;
      this.firstNode.before(this.menuWrapper);
    }
