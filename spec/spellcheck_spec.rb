  ...
  context "when the project contains spelling mistakes" do
    ...
    it "returns the correct errors" do
      ...
      config["forbidden"].each_with_index do |(word, preferred), idx|
        ...
        expect(output_lines[idx + config["forbidden"].length]).to eq(
