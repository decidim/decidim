...
In the Meetings module you have the opportunity to clear the registration forms. To follow that process, you need to run the following task.
...
==== Participatory Process module

In Participatory Processes we have the Process active phase cron that we can use to change the current active step of a Process. To handle the phase change, you need to run the following task.
