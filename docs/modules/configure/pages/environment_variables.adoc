...
|VAPID_PUBLIC_KEY
|VAPID public key that will be used to sign the Push API requests. It can be generated runing the task: `rake decidim:generate`

|VAPID_PRIVATE_KEY
|VAPID private key that will be used to sign the Push API requests. It can be generated runing the task: `rake decidim:generate`
