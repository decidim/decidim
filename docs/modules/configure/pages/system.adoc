...
As there are lots of dependencies in the whole database, currently an Organization cannot be deleted through the system panel. If you still want to go to this direction, there is a snippet for deleting an Organization with a script: link:https://gist.github.com/alexrlpz/90bcdb6304d68d21360d1ffa9c9bd1c7[gist.github.com/alexrlpz/90bcdb6304d68d21360d1ffa9c9bd1c7].
