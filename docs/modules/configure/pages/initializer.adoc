...
The etiquette validator is applied to the create forms of Proposals, Meetings, and Debates for both regular and admin users. Admin users can use the admin panel to create these forms. The validator checks for the following conditions:
...
To disable the etiquette validator, set
[source,ruby]
....
config.disable_etiquette_validator = true
....
