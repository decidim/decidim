...
Below you will find a the recipe of enabling X (former Twitter) milestones, based on https://content-security-policy.com/examples/twitter/[Content Security Policy (CSP) Examples Twitter example].
