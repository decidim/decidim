...
. Then you'll be able to setup the GitHub integration in Crowdin
 ...
 .. Click on "Save"
 .. In less than one hour, if there are any changes in Crowdin that would involve this branch, you'll see the correspondent "Decidim bot" Pull Request in GitHub.
