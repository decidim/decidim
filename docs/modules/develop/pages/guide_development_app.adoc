...
We do not recommend using seed data for production environments, but it's useful for local development and staging environments.
...
If you're working with old branches or there were multiple changes in develop, you will need to re-create your development_app.
