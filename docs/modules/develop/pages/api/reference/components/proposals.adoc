...
== Updating Proposals
The `UpdateProposal` mutation allows authenticated users to updates proposals in a Decidim component. This mutation uses the existing `UpdateProposal` command from controller.
