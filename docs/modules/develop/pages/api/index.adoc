...
*** xref:develop:api/reference/uploads/attachments.adoc[Blobs (Handling Files)]
...
*** xref:develop:api/reference/uploads/attachments.adoc#attachments[Attachments]
...
*** xref:develop:api/reference/uploads/attachments.adoc#attachment-collections[Attachment Collections]
**** xref:develop:api/reference/uploads/attachment_collections/create.adoc[Create Attachment Collections]
**** xref:develop:api/reference/uploads/attachment_collections/update.adoc[Update Attachment Collections]
**** xref:develop:api/reference/uploads/attachment_collections/delete.adoc[Delete Attachment Collections]
