...
You'll need to add this into an initializer. Note that if you are adding this from a module, then you need to add it from the `engine.rb` file (check the docs for content blocks for more info).
