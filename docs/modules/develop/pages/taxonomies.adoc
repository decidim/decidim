...
Taxonomies replaces the old concepts of "Scopes", "Areas" and "Categories" in Decidim. They are a more flexible althought require admins to define the taxonomies and assign them to the entities.
