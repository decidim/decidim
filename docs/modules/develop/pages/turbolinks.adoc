...
Decidim doesn't support `turbolinks` so it is not included on our generated apps and it's removed for existing Rails applications which install the Decidim engine.
