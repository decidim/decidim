...
Check the https://github.com/decidim/decidim/blob/master/docs/services/social_providers.md[Social Providers] document to check the the provider and client configurations.
