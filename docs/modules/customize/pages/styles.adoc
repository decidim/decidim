...
You can go to app/packs/stylesheets/decidim/decidim-settings.scss on your generated applications to override any class using CSS with SASS.

In https://github.com/decidim/decidim/blob/develop/decidim-core/app/packs/stylesheets/decidim/_variables.scss[decidim-core/app/packs/stylesheets/decidim/_variables.scss] you can find the `variables` that can be overriden in your `sass`.
