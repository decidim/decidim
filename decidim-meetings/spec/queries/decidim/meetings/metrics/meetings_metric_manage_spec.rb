...
describe Decidim::Meetings::Metrics::MeetingsMetricManage do
  ...
  let!(:meetings) { create_list(:meeting, 5, created_at: day, component:, taxonomies:) }
  ...
  context "when executing" do
    ...
    it "updates metric records" do
      create(:metric, metric_type: "meetings", day:, cumulative: 1, quantity: 1, organization:, taxonomy: taxonomies.first, participatory_space:)
      registry = generate_metric_registry
