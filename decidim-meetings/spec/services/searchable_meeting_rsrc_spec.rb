  ...
  describe Search do
    ...
    describe "Indexing of meetings" do
      context "when implementing Searchable" do
        it "should insert a SearchableRsrc after Meeting creation" do
        ...
        it "should update the associated SearchableRsrc after Meeting update" do
        ...
        it "should destroy the associated SearchableRsrc after Meeting destroy" do
          meeting.destroy
    ...
    describe "Search" do
      context "when searching by Meeting resource_type" do
        it "should return Meeting results" do
