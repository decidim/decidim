...
RSpec.describe "Meeting directory search" do
  ...
  let(:taxonomy_filter1) { create(:taxonomy_filter, root_taxonomy: taxonomy1.parent, partcipatory_space_manifests: [participatory_space.manifest.name]) }
  let!(:taxonomy_filter1_item) { create(:taxonomy_filter_item, taxonomy_item: taxonomy1, taxonomy_filter: taxonomy_filter1) }
  let(:taxonomy_filter2) { create(:taxonomy_filter, root_taxonomy: taxonomy2.parent, partcipatory_space_manifests: [participatory_space.manifest.name]) }
