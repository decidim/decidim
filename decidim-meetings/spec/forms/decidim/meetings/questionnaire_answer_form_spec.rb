...
module Decidim
  module Meetings
    describe QuestionnaireAnswerForm do
      subject do
        described_class.from_model(questionnaire_answer)
      end
      ...
      let!(:user) { create(:user, organization: questionnaire.meeting.component.participatory_space.organization) }
      ...
      let!(:questionnaire_answer) { build(:questionnaire_answer, user: user, questionnaire: questionnaire, question: questionnaire_question) }
