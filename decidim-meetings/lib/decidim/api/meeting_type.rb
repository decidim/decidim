...
module Decidim
  module Meetings
    class MeetingType < Decidim::Api::Types::BaseObject
      ...
      field :registration_type, Decidim::Meetings::RegistrationTypeType, "The type of registration (disabled, on this platform or different platform)", null: false
      ...
      field :type_of_meeting, Meetings::TypeOfMeetingType, "The type of the meeting (online, hybrid or in-person)", null: false
