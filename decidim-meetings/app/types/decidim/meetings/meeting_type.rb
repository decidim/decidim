...
module Decidim
  module Meetings
    MeetingType = GraphQL::ObjectType.define do
      ...
      field :attendeeCount, types.Int, "Amount of attendees to this meeting", property: :attendee_count
      field :contributionCount, types.Int, "Amount of contributions to this meeting", property: :contribution_count
