      ...
      initializer "decidim_elections_admin.menu" do
        Decidim.menu :admin_elections_menu do |menu|
          ...
          menu.add_item :election_questions_edit,
                        ...
                        @election.nil? || @election.started? ? "#" : current_component_admin_proxy&.edit_questions_election_path(@election),
                        active: @election.present? && !@election.started? && is_active_link?(current_component_admin_proxy&.edit_questions_election_path(@election)),
          ...
          menu.add_item :election_census,
                        ...
                        @election.nil? || @election.started? || @election.questions.blank? ? "#" : current_component_admin_proxy&.census_election_path(@election),
                        active: @election.present? && !@election.started? && is_active_link?(current_component_admin_proxy&.census_election_path(@election)),
