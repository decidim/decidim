...
shared_examples "manage voting components" do
  before do
  ...
  describe "add a component" do
    before do
      visit decidim_admin_votings.components_path(voting)
  ...
  describe "edit a component" do
    ...
    let!(:component) do
      create(:component, name: component_name, participatory_space: voting)
    end
  ...
  describe "publish and unpublish a component" do
    ...
    context "when the component is unpublished" do
      ...
      it "notifies its followers" do
        follower = create(:user, organization: voting.organization)
        create(:follow, followable: voting, user: follower)
  ...
  def participatory_space_components_path(participatory_space)
    decidim_admin_votings.components_path(participatory_space)
  end
end
