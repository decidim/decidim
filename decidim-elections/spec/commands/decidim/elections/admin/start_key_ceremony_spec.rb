...
describe Decidim::Elections::Admin::StartKeyCeremony do
  ...
  let(:method_name) { :start_key_ceremony }
  ...
  context "when valid form" do
    it "logs the performed action", versioning: true do
      expect(Decidim.traceability)
        ...
        .with(:start_key_ceremony, election, user, visibility: "all")
        .and_call_original
    ...
    it "creates an action" do
      ...
      expect(action).to be_start_key_ceremony
    end
