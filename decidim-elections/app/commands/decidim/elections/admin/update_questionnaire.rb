    ...
    module Admin
      ...
      class UpdateQuestionnaire < Decidim::Command
        ...
        def call
          ...
          Decidim.traceability.perform_action!("update", Decidim::Elections::Questionnaire, @form.current_user, { election: @questionnaire.questionnaire_for }) do
            Decidim::Elections::Questionnaire.transaction do
        ...
        def create_questionnaire_for
          @questionnaire.questionnaire_for.save!
        end
