      ...
      class BallotBoxForm < Decidim::Form
        ...
        def validations
          @validations ||= if current_step == "ready"
            [
              [:time_before, { start_time: I18n.l(election.start_time, format: :long), hours: Decidim::Elections.open_ballot_box_maximum_hours_before_start }, election.maximum_hours_before_start?]
            ].freeze
          else
            [
