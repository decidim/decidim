...
shared_examples "manage sortitions" do
  describe "creation" do
    ...
    let(:taxonomy_filter) { create(:taxonomy_filter, root_taxonomy: taxonomy.parent, partcipatory_space_manifests: [current_component.participatory_space.manifest.name]) }
