...
describe "show", type: :system do
  ...
  context "when cancelled sortition" do
    ...
    context "when the field is witnesses" do
      it_behaves_like "has embedded video in description", :witnesses
    end
    context "when the field is additional_info" do
      it_behaves_like "has embedded video in description", :additional_info
    end
    context "when the field is cancel_reason" do
      it_behaves_like "has embedded video in description", :cancel_reason
    end
