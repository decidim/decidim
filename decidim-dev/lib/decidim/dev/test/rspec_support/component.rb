...
Decidim.register_component(:dummy) do |component|
  ...
  component.settings(:global) do |settings|
    ...
    settings.attribute :dummy_global_attribute_2, type: :boolean, disabled: ->(_context) { false }
  ...
  component.settings(:step) do |settings|
    ...
    settings.attribute :dummy_step_attribute_2, type: :boolean, disabled: ->(_context) { false }
    settings.attribute :dummy_step_translatable_text, type: :text, translated: true, editor: true, required: true
    settings.attribute :disabled_step_attribute, type: :boolean, default: true, disabled: ->(_context) { true }
