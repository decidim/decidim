...
Gem::Specification.new do |s|
  ...
  s.add_dependency "rubocop", "~> 1.0", ">= 1.81.6"
  ...
  s.add_dependency "rubocop-performance", "~> 1.25", ">= 1.26.1"
  s.add_dependency "rubocop-rails", "~> 2.0", ">= 2.33.4"
  s.add_dependency "rubocop-rspec", "~> 3.0", ">= 3.7.0"
