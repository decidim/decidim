...
Decidim.register_component(:proposals) do |component|
  ...
  POSSIBLE_SORT_ORDERS = %w(by_default random recent most_endorsed most_voted most_commented most_followed with_more_authors).freeze
  ...
  component.settings(:global) do |settings|
    ...
    settings.attribute :default_sort_order, type: :select, default: "by_default", choices: -> { POSSIBLE_SORT_ORDERS }
