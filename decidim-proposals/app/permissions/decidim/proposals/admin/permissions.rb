    ...
    module Admin
      class Permissions < Decidim::DefaultPermissions
        def permissions
          ...
          allow! if permission_action.subject == :deleted_proposals
          allow! if permission_action.subject == :proposal && permission_action.action == :restore
          allow! if permission_action.subject == :proposal && permission_action.action == :soft_delete
