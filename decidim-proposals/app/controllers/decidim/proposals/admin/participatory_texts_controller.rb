    ...
    module Admin
      ...
      class ParticipatoryTextsController < Admin::ApplicationController
        ...
        def update
          ...
          form_params = params.require(:preview_participatory_text).require(:proposals_attributes)
          form_params.permit!
          @preview_form = form(Admin::PreviewParticipatoryTextForm).from_params(proposals: form_params.values)
