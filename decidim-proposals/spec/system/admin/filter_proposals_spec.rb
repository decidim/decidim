...
describe "Admin filters proposals" do
  ...
  context "when filtering by multiple filters" do
    ...
    let(:taxonomy1_filter) { create(:taxonomy_filter, root_taxonomy: root_taxonomy1, partcipatory_space_manifests: [component.participatory_space.manifest.name]) }
    let(:taxonomy2_filter) { create(:taxonomy_filter, root_taxonomy: root_taxonomy2, partcipatory_space_manifests: [component.participatory_space.manifest.name]) }
