...
describe Decidim::Proposals::Admin::ProposalNoteCreatedEvent do
  ...
  describe "email_subject" do
    it "is generated correctly" do
      expect(subject.email_subject).to eq("Someone left a note on proposal #{resource.title}.")
    end
  end
  ...
  describe "email_intro" do
    it "is generated correctly" do
      expect(subject.email_intro)
        .to eq(%(Someone has left a note on the proposal "#{resource.title}". Check it out at <a href="#{admin_proposal_info_url}">the admin panel</a>))
    end
  end
  ...
  describe "notification_title" do
    it "is generated correctly" do
      expect(subject.notification_title)
        .to include(%(Someone has left a note on the proposal <a href="#{resource_path}">#{resource.title}</a>. Check it out at <a href="#{admin_proposal_info_path}">the admin panel</a>))
    end
  end
end
