...
describe Decidim::Proposals::FilteredProposals do
  ...
  let(:old_proposals) { create_list(:proposal, 3, :published, feature: feature, created_at: 10.days.ago) }
  let(:another_proposals) { create_list(:proposal, 3, :published, feature: another_feature) }
