    ...
    describe MapHelper do
      ...
      describe "#proposal_data_for_map" do
        ...
        it "returns preview data" do
          ...
          expect(subject["body"]).to eq("<div class=\"ql-editor-display\">alert(&quot;HEY&quot;) This is my long, but still super interesting, body of my also long, but also super inte...</div>")
