...
class CreateProposalAdhesions < ActiveRecord::Migration[5.1]
  def change
    ...
    add_index :decidim_proposals_proposal_adhesions, "decidim_proposal_id, decidim_author_id, (coalesce(decidim_user_group_id,-1))", unique: true, name:
      "decidim_proposals_proposal_adhesion_proposal_auth_ugroup_unique"
  end
end
