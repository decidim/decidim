  ...
  module Initiatives
    class InitiativesTypeSignatureTypesController < Decidim::Initiatives::ApplicationController
      ...
      def allowed_signature_types_for_initiatives
        @allowed_signature_types_for_initiatives ||= InitiativesType.where(organization: current_organization).find(params.expect(:type_id)).allowed_signature_types_for_initiatives
      end
    end
  end
end
