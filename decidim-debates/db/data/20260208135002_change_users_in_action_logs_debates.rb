...
class ChangeUsersInActionLogsDebates < ActiveRecord::Migration[7.2]
  ...
  def up
    ActionLog.includes(:user, :resource).where(resource_type: "Decidim::Debates::Debate").find_each do |action_log|
