...
module Decidim
  module Comments
    ...
    module Commentable
      ...
      included do
        has_many :comments, as: :commentable, foreign_key: "decidim_commentable_id", foreign_type: "decidim_commentable_type", class_name: "Decidim::Comments::Comment", counter_cache: "comments_count"
