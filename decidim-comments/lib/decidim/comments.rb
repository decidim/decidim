...
module Decidim
  ...
  module Comments
    ...
    autoload :CommentMetricInterface, "decidim/comments/api/comment_metric_interface"
    autoload :CommentMetricObjectInterface, "decidim/comments/api/comment_metric_object_interface"
