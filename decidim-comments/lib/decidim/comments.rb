...
module Decidim
  ...
  module Comments
    ...
    autoload :CommentsMetricInterface, "decidim/comments/api/comments_metric_interface"
    autoload :CommentsMetricObjectInterface, "decidim/comments/api/comments_metric_object_interface"
