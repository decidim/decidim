  ...
  module Comments
    describe CommentByFollowedUserGroupEvent do
      ...
      describe "email_subject" do
        it "is correct" do
          expect(subject.email_subject).to eq("There is a new comment by #{user_group.name} in #{resource_title}")
        end
      end
      ...
      describe "email_intro" do
        it "is correct" do
          expect(subject.email_intro)
            .to eq("The group #{user_group.name} has left a comment in #{resource_title}. You can read it in this page:")
        end
      end
