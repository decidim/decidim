...
describe Decidim::Comments::UserMentionedEvent do
  ...
  let(:author_link) { "<a href=\"http://#{organization.host}:#{Capybara.server_port}/profiles/#{author.nickname}\" class=\"user-mention\" target=\"_blank\" rel=\"nofollow noopener noreferrer ugc\">@#{author.nickname}</a>" }
