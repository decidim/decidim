    ...
    describe Comment do
      ...
      describe "#formatted_body" do
        ...
        describe "when the body contains urls" do
          ...
          let(:result) do
            %(<div><p>Content with URLs of anchor type and text urls like <a href="https://decidim.org" target="_blank" rel="noopener">https://decidim.org</a>. And a malicous click me</p></div>)
          end
