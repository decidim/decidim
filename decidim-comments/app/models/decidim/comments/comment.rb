...
module Decidim
  module Comments
    ...
    class Comment < ApplicationRecord
      ...
      #belongs_to :commentable, foreign_key: "decidim_commentable_id", foreign_type: "decidim_commentable_type", polymorphic: true, counter_cache: "commentable_comments_count"
