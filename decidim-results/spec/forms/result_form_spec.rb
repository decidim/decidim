...
describe Decidim::Results::Admin::ResultForm do
  ...
  let(:current_feature) { create :feature, featurable: participatory_process, manifest_name: "results" }
  let(:title) do
  ...
  context "with proposals" do
    let(:proposals_feature) { create :feature, manifest_name: :proposals, featurable: participatory_process }
