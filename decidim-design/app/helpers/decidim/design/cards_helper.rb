  ...
  module Design
    module CardsHelper
      ...
      def source_contents
        ...
        if Decidim.module_installed?(:accountability) && (resource = Decidim::Accountability::Result.last).present?
          contents += [
        ...
        if Decidim.module_installed?(:blogs) && (resource = Decidim::Blogs::Post.last).present?
          contents += [
        ...
        if Decidim.module_installed?(:budgets) && (resource = Decidim::Budgets::Project.last).present?
          contents += [
        ...
        if Decidim.module_installed?(:debates) && (resource = Decidim::Debates::Debate.last).present?
          contents += [
        ...
        if Decidim.module_installed?(:meetings) && (resource = Decidim::Meetings::Meeting.last).present?
          contents += [
        ...
        if Decidim.module_installed?(:proposals)
          ...
          contents << { values: section_subtitle(title: "Proposals") } if [proposal_resource, collaborative_draft_resource].any?(&:present?)
        ...
        if Decidim.module_installed?(:sortitions) && (resource = Decidim::Sortitions::Sortition.last).present?
          contents += [
        ...
        if Decidim.module_installed?(:assemblies) && (resource = Decidim::Assembly.last).present?
          contents += [
        ...
        if Decidim.module_installed?(:conferences) && (resource = Decidim::Conference.last).present?
          contents += [
        ...
        if Decidim.module_installed?(:elections)
          election_resource = Decidim::Elections::Election.last
          voting_resource = Decidim::Votings::Voting.last

          contents << { values: section_subtitle(title: "Elections") } if [election_resource, voting_resource].any?(&:present?)

          if (resource = election_resource).present?
            contents += [
              cell_table_item(
                "Election G",
                {
                  cell: "decidim/elections/election_g",
                  args: [resource],
                  call_string: [
                    "card_for(_RESOURCE_)",
                    "card_for(_RESOURCE_, size: :g)",
                    'cell("decidim/elections/election", _RESOURCE_)',
                    'cell("decidim/elections/election", _RESOURCE_, size: :g)',
                    'cell("decidim/elections/election_g", _RESOURCE_)'
                  ]
                }
              ),
              cell_table_item(
                "Election S",
                {
                  cell: "decidim/elections/election_s",
                  args: [resource],
                  call_string: [
                    "card_for(_RESOURCE_, size: :s)",
                    'cell("decidim/elections/election", _RESOURCE_, size: :s)',
                    'cell("decidim/elections/election_s", _RESOURCE_)'
                  ]
                }
              )
            ]
          ...
          if (resource = voting_resource).present?
            contents += [
              cell_table_item(
                "Voting G",
                {
                  cell: "decidim/votings/voting_g",
                  args: [resource],
                  call_string: [
                    "card_for(_RESOURCE_)",
                    "card_for(_RESOURCE_, size: :g)",
                    'cell("decidim/votings/voting", _RESOURCE_)',
                    'cell("decidim/votings/voting", _RESOURCE_, size: :g)',
                    'cell("decidim/votings/voting_g", _RESOURCE_)'
                  ]
                }
              ),
              cell_table_item(
                "Voting S",
                {
                  cell: "decidim/votings/voting_s",
                  args: [resource],
                  call_string: [
                    "card_for(_RESOURCE_, size: :s)",
                    'cell("decidim/votings/voting", _RESOURCE_, size: :s)',
                    'cell("decidim/votings/voting_s", _RESOURCE_)'
                  ]
                }
              )
            ]
        ...
        if Decidim.module_installed?(:initiatives) && (resource = Decidim::Initiative.last).present?
          contents += [
        ...
        if Decidim.module_installed?(:participatory_processes)
          ...
          contents << { values: section_subtitle(title: "Participatory Processes") } if [process_resource, process_group_resource].any?(&:present?)
