  ...
  module Budgets
    ...
    class Engine < ::Rails::Engine
      ...
      initializer "decidim_budgets.register_icons" do
        Decidim.icons.register(name: "Decidim::Budgets::Budget", icon: "coin-line", description: "Budget", category: "activity", resource: "core", engine: :budgets)
        Decidim.icons.register(name: "Decidim::Budgets::Project", icon: "coin-line", description: "Project (Budgets)", category: "activity", resource: "core", engine: :budgets)
        Decidim.icons.register(name: "Decidim::Budgets::Order", icon: "check-double-fill", description: "Budget voting", category: "activity", resource: "core", engine: :budgets)

        Decidim.icons.register(name: "git-pull-request-line", icon: "git-pull-request-line", resource: "core", category: "system", description: "", engine: :budgets)
        Decidim.icons.register(name: "list-check", icon: "list-check", resource: "core", category: "system", description: "", engine: :budgets)
      end
