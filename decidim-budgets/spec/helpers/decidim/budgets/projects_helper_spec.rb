    ...
    describe ProjectsHelper do
      ...
      describe "#project_data_for_map" do
        ...
        it "returns preview data" do
          ...
          expect(subject["description"]).to eq("<div class=\"ql-editor ql-reset-decidim editor-content\">alert(&quot;HEY&quot;) This is my long, but still super interesting, description of my also long, but also sup…</div>")
