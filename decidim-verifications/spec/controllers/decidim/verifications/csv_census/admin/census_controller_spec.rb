  ...
  describe CensusController do
    ...
    describe "POST #create" do
      before do
        ...
        form = instance_double(Decidim::Verifications::CsvCensus::Admin::CensusDataForm, errors: form_errors, file: nil)
    ...
    describe "DELETE #destroy_all" do
      it "enforces permission to destroy authorizations" do
        ...
        delete :destroy_all, params: { id: csv_datum.id }
      end
    end
    ...
    context "when user is a process admin" do
      ...
      it "does not allow destroy_all" do
        delete :destroy_all, params: { id: csv_datum.id }
