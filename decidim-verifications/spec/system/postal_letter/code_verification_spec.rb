...
describe "Postal letter code verification" do
  ...
  context "when code requested but letter not sent" do
    ...
    it "shows an informative message to the user" do
      expect(page)
        .to have_text("We will send a letter to your address with your verification code soon.")
    end
  end
    ...
    context "and user verifies the code" do
      ...
      context "when code is incorrect" do
        ...
        it "shows an error message" do
          expect(page).to have_text("Your verification code does not match ours. Please double-check the letter we sent to you.")
        end
      end
