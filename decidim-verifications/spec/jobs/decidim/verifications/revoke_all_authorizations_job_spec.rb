...
module Decidim::Verifications
  describe RevokeAllAuthorizationsJob do
    ...
    # With 6 authorizations, 4 granted, 2 pending, only 1 granted & managed
    ...
    describe "With 4 granted auths and 2 ungranted auths" do
      it "does not destroy any ungranted auth" do
        expect do
          subject.perform_now(organization, current_user)
      ...
      it "traces the action", versioning: true do
        ...
        expect { subject.perform_now(organization, current_user) }.to change(Decidim::ActionLog, :count)
