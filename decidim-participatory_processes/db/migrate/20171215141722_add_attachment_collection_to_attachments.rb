...
class AddAttachmentCollectionToAttachments < ActiveRecord::Migration[5.1]
  def change
    ...
    add_foreign_key :decidim_attachments, :decidim_attachment_collections, column: :attachment_collection_id, on_delete: :nullify, name: "fk_decidim_attachments_attachment_collection_id"
  end
end
