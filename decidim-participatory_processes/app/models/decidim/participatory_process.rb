...
module Decidim
  ...
  class ParticipatoryProcess < ApplicationRecord
    ...
    def sidebar_content_block
      @sidebar_content_block ||= Decidim::ContentBlock.for_scope(:topics_sidebar, organization: organization).
        where(manifest_name: :html, scoped_resource_id: id).first_or_initialize
    end
