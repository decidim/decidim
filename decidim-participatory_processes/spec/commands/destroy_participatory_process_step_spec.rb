...
describe Decidim::ParticipatoryProcesses::Admin::DestroyParticipatoryProcessStep, class: true do
  ...
  context "when there's more than one step" do
    ...
    context "when destroying an inactive step" do
      ...
      it "reorders the remaining steps" do
        allow(Decidim::ParticipatoryProcesses::Admin::ReorderParticipatoryProcessSteps)
          .to receive(:new)
