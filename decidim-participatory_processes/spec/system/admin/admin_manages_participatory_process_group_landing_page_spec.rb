...
describe "Admin manages participatory process group landing page", type: :system do
  ...
  def edit_content_block_path(resource, manifest_name)
    decidim_admin_participatory_processes.edit_participatory_process_group_landing_page_content_block_path(resource, manifest_name)
  end
  ...
  context "when editing a persisted cta content block" do
    ...
    it "shows settings of cta" do
      visit edit_content_block_path(resource, :cta)
