...
describe "Private Participatory Processes" do
  ...
  let!(:member) { create(:member, user: other_user, participatory_space: private_participatory_process) }
  let!(:member2) { create(:member, user: other_user2, participatory_space: private_participatory_process) }
