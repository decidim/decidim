...
shared_examples "manage process steps examples" do
  ...
  it "creates a new participatory_process" do
    ...
    fill_in :participatory_process_step_start_date, with: DateTime.now.change(day: 12)
    fill_in :participatory_process_step_end_date, with: DateTime.now.change(day: 12)
