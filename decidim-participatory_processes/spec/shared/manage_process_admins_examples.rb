...
shared_examples "manage process admins examples" do
  ...
  it "creates a new process admin", versioning: true do
    ...
    expect(page).to have_admin_callout("Admin successfully added to this participatory process.")
  ...
  describe "when managing different users" do
    ...
    it "updates a process admin", versioning: true do
      ...
      expect(page).to have_admin_callout("Admin successfully updated for this participatory process.")
    ...
    it "deletes a participatory_process_user_role" do
      ...
      expect(page).to have_admin_callout("Admin successfully removed from this participatory process.")
