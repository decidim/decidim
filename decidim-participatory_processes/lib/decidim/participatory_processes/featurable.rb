...
Decidim.register_featurable(:participatory_processes) do |featurable|
  featurable.engine = Decidim::ParticipatoryProcesses::Engine
  featurable.admin_engine = Decidim::ParticipatoryProcesses::AdminEngine
  featurable.icon = "decidim/participatory_processes/icon.svg"
