...
module Decidim
  module ParticipatoryProcesses
    ...
    class Engine < ::Rails::Engine
      ...
      initializer "decidim_participatory_processes.importmap", before: "importmap" do |app|
        app.config.importmap.paths << Engine.root.join("config/importmap.rb")
        app.config.importmap.cache_sweepers << Engine.root.join("app/packs/src")
      end

      initializer "decidim_participatory_processes.importmap.assets", before: "importmap.assets" do |app|
