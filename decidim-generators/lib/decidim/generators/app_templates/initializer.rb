...
Decidim.configure do |config|
  ...
  config.disable_etiquette_validator = Rails.application.secrets.decidim[:disable_etiquette_validator] if Rails.application.secrets.decidim[:disable_etiquette_validator].present?
end
