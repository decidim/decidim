  ...
  let(:secrets_on) do
    {
      ...
      %w(decidim elections setup_minimum_hours_before_start) => 4,
      %w(decidim elections start_vote_maximum_hours_before_start) => 7,
      %w(decidim elections voter_token_expiration_minutes) => 123,
