...
module Decidim
  module Accountability
    class ResultType < Decidim::Api::Types::BaseObject
      ...
      field :projects, [Decidim::Budgets::ProjectType, { null: true }], "The projects linked to this result", null: true
      field :proposals, [Decidim::Proposals::ProposalType, { null: true }], "The proposals linked to this result", null: true
