...
module Decidim
  module Accountability
    class ResultAttributes < Decidim::Api::Types::BaseInputObject
      ...
      argument :external_id, GraphQL::Types::String, "External ID of this result", required: false
      ...
      argument :weight, GraphQL::Types::Int, "Order of this result", required: false
    end
  end
end
